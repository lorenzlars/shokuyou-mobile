...
export class ScheduledMealsService {
    ...
    public static createScheduledMeal<ThrowOnError extends boolean = false>(options: Options<CreateScheduledMealData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).post<CreateScheduledMealResponse, unknown, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
    ...
    public static updateScheduledMeal<ThrowOnError extends boolean = false>(options: Options<UpdateScheduledMealData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).put<UpdateScheduledMealResponse, unknown, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
...
export class SyncService {
    public static syncPull<ThrowOnError extends boolean = false>(options: Options<SyncPullData, ThrowOnError>) {
    ...
    public static syncPush<ThrowOnError extends boolean = false>(options: Options<SyncPushData, ThrowOnError>) {
        return (options.client ?? _heyApiClient).post<unknown, unknown, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
