...
export type CreateScheduledMealsResponseDto = {
  meals: ScheduledMealResponseDto[];
};

export type ScheduledMealResponsePaginatedDto = {
  total: number;
  content: ScheduledMealResponseDto[];
};
...
export type UpdateIngredientsResponse =
  UpdateIngredientsResponses[keyof UpdateIngredientsResponses];
...
export type GetScheduledMealsResponse =
  GetScheduledMealsResponses[keyof GetScheduledMealsResponses];
...
export type CreateScheduledMealResponse =
  CreateScheduledMealResponses[keyof CreateScheduledMealResponses];
...
export type UpdateScheduledMealResponse =
  UpdateScheduledMealResponses[keyof UpdateScheduledMealResponses];
