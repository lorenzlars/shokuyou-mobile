...
type RecipesStackNavigatorProps = StackScreenProps<
  RecipesNavigationParamList,
  keyof RecipesNavigationParamList
>;

export type RecipesNavigatorParams = CompositeNavigationProps<
  RootNavigatorProps,
  RecipesStackNavigatorProps
>;
      ...
      screenOptions={{
        ...
        headerRight: () => (
          <View style={styles.headerActionsContainer}>
            ...
            <NavigationButton icon="plus" onPress={() => navigation.navigate('RecipeForm')} />
          </View>
        ),
      }}>
